                        ...
                        <form method="post">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <textarea name="alamat" rows="5" class="form-control" value="<?php echo $data ['alamat'];?>" type="text"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td>No Telepon</td>
                                    <td>:</td>
                                    <td><input class="form-control" type="number" value="<?php echo $data ['no_telepon'];?>" name="no_telepon"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
