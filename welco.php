      ...
      <div class="container-fluid">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="col-12 col-lg-auto mx-5  mb-4 me-lg-3 ml-2 ">
          <input type="search" class="form-control form-control-dark" placeholder="Search..." aria-label="Search">
        </form>

        <div class="md-4 mb-4 me-2">
        ...
        <div class="col-md-5 col-lg-4 offset-md-1">
          <div class="form_container">
            ...
            <form action="" method="post">
              ...
              <div>
                <input type="text" class="message-box" placeholder="pesan"  name="pesan" required>>
              </div>
              <div>
...
// Fungsi untuk menyimpan komentar baru ke dalam database
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query untuk menyimpan komentar baru
    $insert_query = "INSERT INTO komentar (nama, email, subject, message, sent_at) VALUES ('$nama', '$email', '$subject', '$message', '$sent_at')";
...
// Pastikan hasil kueri benar
if ($result->num_rows > 0) {
    // output data setiap baris
    while($datas = $result->fetch_assoc()) {
        echo "<div class='comment'>";
        echo "<div class='author'><strong>" . $datas["nama"] . "</strong></div>";
        echo "<div class='email'>" . $datas["email"] . "</div>";
        echo "<div class='text'>" . $datas["subject"] . "</div>";
        echo "<div class='text'>" . $datas["message"] . "</div>";
        echo "<div class='text'>" . $datas["sent_at"] . "</div>";
        echo "</div>";
    }
} else {
