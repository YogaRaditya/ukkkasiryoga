...
<div class="container-fluid px-4">
                        <h1 style="mt-6 text">Selamat datang, <?php echo $_SESSION['user']['username']; ?>!</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body"><?php echo mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM detail_penjualan")); ?> Laporan</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
