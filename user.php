...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark shadow-lg bg-primary">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-1" href="index.html">Aplikasi Kasir Baknus 666  </a>
            <!-- Sidebar Toggle-->
